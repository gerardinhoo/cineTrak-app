const global = {
   ...
   api: {
      apiKey: '3067dad5ebf9981bfdfe3f4abd9d7e73',
...
async function displayshowDetails() {
   ...
   // Overlay for background Image
   displayBagroundImage('show', show.backdrop_path)
   const div = document.createElement('div');
   ...
   div.innerHTML =  `
        ...
        <div class="details-bottom">
          ...
          <ul>
            ...
            <li><span class="text-secondary">Last Episode To Air:</span> ${show.name})}</li>
...
function displayBagroundImage(type, backgroundPath) {
